...
<jsp:useBean id="topRated" class="com.cis550.Beans.TopRatedBean"
	scope="application">
...
<link href="css/css_top_rated.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="business_body">
<div id="business_body_position">
...
<br/>
<%
	ArrayList<String> sites = topRated.getTopRatedSites((String)session.getAttribute("name"));
	if (sites != null){
		for (String site: sites){
			out.print(site+"<BR/>");
		}
		if (sites.size() == 0){
			out.print("<big>There is no Business news!</big><br/>");
