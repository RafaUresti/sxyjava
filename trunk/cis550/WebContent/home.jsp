...
out.print("You are logged in " + name);	
}
...
<br/>
<%
categorizedNews.setCategory("all", (String)session.getAttribute("name"));
	...
	if (sites != null){
		...
		if (sites.size() == 0){
			out.print("<big>There is no news!</big><br/>");
