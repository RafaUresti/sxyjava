...
<link href="css/css_entertainment.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="entertainment_body_position">
...
<br/>
<%
categorizedNews.setCategory("Entertainment", (String)session.getAttribute("name"));
	...
	if (sites != null){
		...
		if (sites.size() == 0){
			out.print("<big>There is no Entertainment news!</big><br/>");
