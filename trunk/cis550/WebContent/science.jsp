...
<link href="css/css_science.css" rel="stylesheet" type="text/css" />
</head>
...
<br/>
<%
categorizedNews.setCategory("Science", (String)session.getAttribute("name"));
	...
	if (sites != null){
		...
		if (sites.size() == 0){
			out.print("<big>There is no Science news!</big><br/>");
