...
public interface RINsRPC extends RemoteService{
	...
	public RIN[] getAvailableRINs(Invoice sellInvoice) throws RINException, AuthorizationException;
	public void saveAvailableRINsPositions(List<Integer> rinIds, List<Integer> rinPositions) throws RINException, AuthorizationException;
	public String getVersionDetail() throws Exception;//method to get the version number 
	/**
	 * Generate RFS report
