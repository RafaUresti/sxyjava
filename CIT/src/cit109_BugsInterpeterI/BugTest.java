package cit109_BugsInterpeterI;
import java.awt.Color;

import javax.lang.model.element.UnknownElementException;

import cit107_BuildingTrees.Tree;
import cit108_ParserForBugsLanguage.*;
...
public class BugTest {
	...
	public void testInterpretBlock(){
		...
		bug.interpret(getParserTopTree());
		assertTrue(Bug.areEqualDoubles(bug.angle, 30.0));
	...
	public void testInterpretLoop(){
		...
		bug.store("y", 1024.0);
		bug.store("angle", 0.5);
		bug.store("innerCounter", 0);
		bug.store("outerCounter", 0);
		bug.interpret(getParserTopTree());
