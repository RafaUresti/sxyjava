...
public class PennChordMessage implements Serializable{
	...
	public static enum MessageType {JOIN, JOIN_REPLY, TRANSFER_DATA, CHANGE_SUCCESSOR, CHANGE_PREDECESSOR,
		NOTIFY, STABILIZE, STABILIZE_REPLY,LOOKUP, LOOKUP_REPLY, STORE, REQUEST_DATA, RINGSTATE_OUTPUT, REQUEST_DEBUG, REQUEST_LOOKUP_HOPS}
	private int src;
	private BigInteger srcAddrKey; 
	private MessageType messageType;
	private BigInteger argument1;
	private BigInteger argument2;
	private String key;	
	private ArrayList<String> value;
	private boolean debugOn;

	public PennChordMessage(int src, BigInteger srcAddrKey, MessageType messageType, 
			BigInteger argument1, BigInteger argument2, String key, ArrayList<String> value){
		this.src = src;
	...
	public BigInteger getSrcAddrKey() {
    return srcAddrKey;
  }

  public void setSrcAddrKey(int srcAddrKey) {
    this.srcAddrKey = new BigInteger(srcAddrKey+"");
  }
	...
	public BigInteger getArgument1() {
		return argument1;
	}
	
	public void setArgument1(BigInteger argument1){
		this.argument1 = argument1;
	}
	
	public BigInteger getArgument2() {
    return argument2;
  }
  
  public void setArgument2(BigInteger argument2){
    this.argument2 = argument2;
  }
